function plot_mission_contourf_section(data,usebathyfile,paramplot,figparam)
% function plot_mission_contourf_section(data,usebathyfile,paramplot,figparam)
%     
...
figsecnb     = ['sec' num2str(data.sectionnb) '_contourf'];
...
colormap(paramplot.colmap)
    ...
    contourf(xdata,ydata,cdata,clip,'linestyle','none')       
    hold on         
