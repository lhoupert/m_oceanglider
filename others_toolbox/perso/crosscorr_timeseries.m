function varargout = crosscorr_timeseries(y1,y2,numLags,numSTD)
%CROSSCORR Sample cross-correlation
% modifided by Loic Houpert to taking into account integral timescale of
% time series in the calculation of the confidence interval 
%
% Syntax:
%
...
[~,dof1] = decorrelation3(1:length(y1),y1,0);  
[~,dof2] = decorrelation3(1:length(y2),y2,0); 
N = min(dof1,dof2);
