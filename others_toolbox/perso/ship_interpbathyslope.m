function [aspecti,slopei]=ship_interpbathyslope(bathyname,lon,lat,bathydir)
...
[aspect,slope,dFdyNorth,dFdxEast] = gradientm(lgbathy2,ltbathy2,zbathy2);

% figure; 
% sp1=subplot(1,2,1);
% surf(lgbathy2,ltbathy2,zbathy2);view([0 90]);shading interp;colorbar; caxis([ -1300 -600])
% latratio(58)
% sp2=subplot(1,2,2);
% surf(lgbathy2,ltbathy2,aspect);view([0 90]);shading interp;colorbar
% latratio(58)
% linkaxes([sp1,sp2])

%figure; surf(lgbathy2,ltbathy2,aspect);view([0 90]);shading interp;colorbar


aspecti=interp2(lgbathy2,ltbathy2,aspect,lon,lat);
slopei=interp2(lgbathy2,ltbathy2,slope,lon,lat);
