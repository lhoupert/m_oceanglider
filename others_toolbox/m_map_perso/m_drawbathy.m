function [cs,h]=m_drawbathy(optn,bathyname,zlvls, limitcmap,bathydir)
% function [cs,h]=m_drawbathy(optn,bathyname, zlvls, limitcmap,bathydir))
...
% minlat maxlat]
% bathydir (ex: ~/Data/Dropbox/Work/function_matlab/bathymetrie/)

load('MyColormaps')
%load('cmap_map');medcmap=cmap;
% zlvl1=-2800:50:-2550;
% zlvl2=-3000:10:-2810;
...
%          [cs0,h0]=contourf(lgbathy2,ltbathy2,zbathy2,zlvls);colormap(medcmap*0+1);
%         [cs0,h0]=m_contourf(lgbathy2,ltbathy2,zbathy2,[-10000 0]);colormap([[1 1 1];[1 1 1];[0.6 0.6 0.6]]);
         %lgcont=lgbathy2;  ltcont=ltbathy2;   zcont=zbathy2;
%         view([0 90])
         hold on
%         set(h0,'Linestyle','none');
         [cs,h]=m_contour(lgbathy2,ltbathy2,zbathy2,zlvls);
          set(h,'linecolor',[0.55 0.55 0.55]) ;             
...
elseif strfind(bathyname,'etopo2')
    ...
    fic_bathy = [bathydir filesep 'bathy_etopo2.nc'];
