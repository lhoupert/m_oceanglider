...
% zlvls (ex: -3000:50:0)
% limitcmap = limit lat, lon pour fixer la colormap (la zone doit englober la cote et la profondeur max désiré) pour la terre soit en gris), limitcmap=[minlon maxlon minlat maxlat]
load('MyColormaps')
zlvl1=-2800:50:-2550;
zlvl2=-3000:10:-2810;
